...
class UserControllerTest {
    ...
    void testRegisterSuccess() throws Exception {
        ...
        mockMvc.perform(
            ...
            // Tambahkan log debug
            System.out.println("Payload permintaan: " + objectMapper.writeValueAsString(request));
            System.out.println("Payload respons: " + result.getResponse().getContentAsString());
    ...
    void updateUserSuccess() throws Exception {
        ...
        mockMvc.perform(
            ...
            assertNull(response.getErrors());
            assertEquals("AW", response.getData().getName());
            assertEquals("test", response.getData().getUsername());
            
            User userDb =  userRepository.findById("test").orElse(null);
            assertNotNull(userDb);
            assertTrue(BCrypt.checkpw("aw12345", userDb.getPassword()));
